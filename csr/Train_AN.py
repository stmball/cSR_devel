...
from csr.ML.Train_AN import Trainer, StaticModel, Runner, ActiveLearner, Split, TrainingSplit, SharedDataView
from csr.ML.LearnToRank import Pairwise
from csr.ML.Train_AN import create_crossvalidation_splits, undersample
...
#        'SofiaSVM':           SofiaSVM,
    ...
    with open(args.pipeline, 'r') as pipeline_file:
        pipeline_def = yaml.load(pipeline_file)
