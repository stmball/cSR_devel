...
VERBOSITY="6"
OUTPUT_NAME="../runs/COMET/static_amended_SR5"
INPUT_NAME="data/full/COMET/COMET_all_update5.json"
...
python -m bin.Train --data $INPUT_NAME \
       ...
       --RF_mode 'none' \
       --train_on abstract!=_ split!=update5 \
       --test_on  abstract!=_ split=update5 \
       --output "${OUTPUT_NAME}_update5.json" \
...
python -m bin.Train --data $INPUT_NAME \
       ...
       --classifier $CLASSIFIER \
       --RF_mode 'none' \
       --train_on abstract!=_ split!=update4 split!=update5 \
...
python -m bin.Train --data $INPUT_NAME \
       ...
       --classifier $CLASSIFIER \
       --RF_mode 'none' \
       --train_on abstract!=_ split!=update2 split!=update3 split!=update4 split!=update5 \
...
python -m bin.Train --data $INPUT_NAME \
       ...
       --classifier $CLASSIFIER \
       --RF_mode 'none' \
       --train_on abstract!=_ split!=update3 split!=update4 split!=update5 \
