...
declare -a sources2017=("CD007394"
		    ...
		    "CD011984"
		    "CD012019")
declare -a sources2018=("CD011420"
			"CD011431"
			"CD011515"
			"CD011602"
			"CD011686"
...
do
   python -m bin.Train --data data/full/clef2018_ALL \
       ...
       --pickled_meta_classifier ../models/CLEF2017/clef2017_meta_dense_3x16_ES_inner_4f \
       --RF_mode 'Y|MN' \
       --train_on split=seed  source="$s" \
       --test_on  split!=seed source="$s" \
       --output_format 'TREC' \
       --output ../runs/CLEF/20180508/meta_B_"$s" \
       --n_repetitions 1 \
       --verbosity 10
done
