...
Y = DataStream.parse(open('data/full/OMaraEves/OMaraEves_Y.json').read())
Y.add_column('label', 'Y')

Pubmed_in = DataStream.parse(open('data/full/OMaraEves/OMaraEves_201906_pubmed.json').read())
IEEE_in   = DataStream.parse(open('data/full/OMaraEves/OMaraEves_201906_ieee.json').read())
ACMDL_in  = DataStream.parse(open('data/full/OMaraEves/OMaraEves_201906_acmdl.json').read())
